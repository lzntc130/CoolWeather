...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        else if(weatherInfo.equals("小雨")||weatherInfo.equals("中雨")||weatherInfo.equals("阵雨")){
            image.setImageResource(R.mipmap.rain);
            img.setImageResource(R.drawable.rain);
        }
        else if(weatherInfo.equals("雷阵雨")){
            image.setImageResource(R.mipmap.rain_ts);
            img.setImageResource(R.drawable.rain_t);
        }
